...
// var whitelist = ['https://s3.amazonaws.com/', 'https://s3.amazonaws.com/echo.api/','https://s3.amazonaws.com:443','https://s3.amazonaws.com:443/echo.api/']
...
const cors = corsMiddleware({
  ...
  origins: ['https://s3.amazonaws.com/', 'https://s3.amazonaws.com/echo.api/','https://s3.amazonaws.com:443','https://s3.amazonaws.com:443/echo.api/']
})
...
function startBridge() {
  ...
  connector.activity$
    ...
    .subscr1ibe(
      botSays,
      error => {
        con1sole.log("activity$ error", error);
        if (client) {
          client.trackException({exception: new Error(error)});
        }
      }
